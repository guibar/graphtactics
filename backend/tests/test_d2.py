...
def road_network_d2() -> RoadNetwork:
    return RoadNetworkFactory().create("d2")


def test_run_d2_1(road_network_d2):
...
def test_run_d2_2(road_network_d2):
    lkp = Point(2.10496, 49.40171)
    time_lkp = datetime.fromisoformat("2020-12-01T09:00:00")
    scenario = Scenario(
        road_network_d2,
...
def test_point(road_network_d2):
...
def test_run_d2_3(road_network_d2):
